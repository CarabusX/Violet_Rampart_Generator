...
local BORDER_TYPE_SHARP_EDGE    = 2
local BORDER_TYPE_WALL          = 3
local BORDER_TYPE_INTERNAL_WALL = 4
...
local MAP_INITIAL_HEIGHT = RAMPART_HEIGHT
local INITIAL_HEIGHT     = BOTTOM_HEIGHT
local MIN_HEIGHT         = BOTTOM_HEIGHT
local MAX_HEIGHT         = RAMPART_WALL_HEIGHT
...
EXPORT = {
	...
	BORDER_TYPE_SHARP_EDGE = BORDER_TYPE_SHARP_EDGE,
